...
//     public static void diagonalT(Node root, int diag, HashMap<Integer, ArrayList<Integer>>map)
//     {
//         if(root==null)
//         {
//             return;
...
//         diagonalT(root.left,diag+1,map);
//         diagonalT(root.right,diag,map);
